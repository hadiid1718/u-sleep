...
Rate: ${user.jobPreferences?.rateType === 'hourly' ? 
...
Please integrate this case study naturally into the proposal to add credibility and authority, showing similar past success.`;
     ...
     */
    async upgradeProposalWithCaseStudy(proposal, job, user, caseStudy, aiService = 'openai') {
    ...
    async upgradeWithOpenAI(upgradePrompt) {
        const payload = {
            ...
            messages: [
                {
                    role: 'system',
                    content: 'You are an expert at enhancing Upwork proposals with case studies while maintaining professionalism and conciseness.',
                },
                {
                    role: 'user',
