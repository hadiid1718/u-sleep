...
const Header = () => {
  ...
  return (
    <>
      <header className="flex justify-between items-center px-6 py-4 bg-blue-600 relative z-50">
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed top-0 right-0 h-full w-64 bg-gray-800 text-white transform transition-transform duration-300 ease-in-out z-50 md:hidden ${
